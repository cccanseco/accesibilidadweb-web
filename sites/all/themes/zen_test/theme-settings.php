 ...
 */
function zen_test_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['zen_test_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('zen_test sample setting'),
  '#default_value' => theme_get_setting('zen_test_example'),
